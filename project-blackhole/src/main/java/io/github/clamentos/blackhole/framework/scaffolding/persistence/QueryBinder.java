...
/**
 * <h3>Query Binder</h3>
 * <p>Specifies that the implement class can bind entity parameters to a JDBC statement.</p>
 * <b>NOTE: binding order is important and must reflect the order of the database columns.</b>
 * @see Entity
 * @see Filter
*/
