 ...
 *     <li>METHOD_NOT_ALLOWED: request specified an unknown or illegal method (see {@link Methods}).</li>
 *     <li>UNKNOWN_RESOURCE_TYPE: request specified an unknown resource type (see {@link Resources}).</li>
