package io.github.clamentos.blackhole.business;
 ...
 * <ul>
 *     <li>{@code SYSTEM}: Targets the System entity, which can be used to aquire various stats about the currently running system.</li>
    ...
    */
    public static Resources newInstance(byte resource_id) throws IllegalArgumentException {
        ...
        switch(resource_id) {
            ...
            default: throw new IllegalArgumentException("Unknown resource type: " + resource_id);
        }
    }
